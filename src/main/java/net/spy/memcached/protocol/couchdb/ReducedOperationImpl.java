...
public class ReducedOperationImpl extends HttpOperationImpl
		implements ReducedOperation {
	...
	public void handleResponse(HttpResponse response) {
		...
		try {
			...
			exception = new OperationException(OperationErrorType.GENERAL, "Error parsing JSON");
		}
		callback.complete();
	}
