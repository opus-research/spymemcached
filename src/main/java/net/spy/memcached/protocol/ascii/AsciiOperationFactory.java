...
public class AsciiOperationFactory extends BaseOperationFactory {
	...
	public GATOperation gat(String key, int expiration, GATOperation.Callback cb) {
		throw new UnsupportedOperationException("Gat not supported with ascii protocol");
	}
