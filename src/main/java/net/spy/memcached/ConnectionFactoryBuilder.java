...
public class ConnectionFactoryBuilder {
	 ...
	 * Note that a MembaseConnectionFactory requires the the hash algorithm
	 * is a ketama hash, the failure mode is set to retry, and the locator
	 * type is discovered dynamically based on the cluster you are connecting
	 * to. As a result, these values will be overridden upon calling this
	 * function.
	 *
