...
public class BinaryClientTest extends ProtocolBaseCase {
	...
	public void testSync() throws Exception {
		if (isMembase()) {
			client = new MemcachedClient(Arrays.asList(new URI("http://localhost:8091/pools")), "default", "default", "");
			...
			Collection<SyncResponse> resp = client.asyncSync(keys, 0, false, false, false).get();
