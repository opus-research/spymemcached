...
public class CouchbaseClient extends MembaseClient
  ...
  public ViewFuture asyncQuery(View view, Query query) {
    ...
    String params =
        (queryString.length() > 0) ? "&reduce=false" : "?reduce=false";
  ...
  /**
   * Asynchronously queries a Couchbase view by calling it's map function. This
  ...
  /**
   * Asynchronously queries a Couchbase view by calling it's map function and
  ...
  /**
   * Queries a Couchbase view by calling it's map function. This type of query
  ...
  /**
   * Queries a Couchbase view by calling it's map function and then the views
   * reduce function.
   *
   * @param view the view to run the query against.
   * @param query the type of query to run against the view.
